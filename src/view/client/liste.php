...
<div class="content" id="ajax-content">
    ...
    $i = 0;
      foreach ($data as $cl) { 
        ...
        <td><?= $cl->getAdresse() ?></td>
        <td><?= $cl->getTel() ?></td>
        <td><button type="button" class="btn btn-outline-success addCompte" idCl="<?= $cl->getId() ?>" data-toggle="modal" data-target="#basicExampleModal">AJOUTER NOUVEAU COMPTE</button> <button type="button" class="btn btn-outline-primary listCompte" data-toggle="modal" data-target="#centralModalSm" idCl="<?= $cl->getId() ?>">LISTE DES COMPTES</button> 
        <button type="button" class="btn btn-outline-danger supprimerCl" idCl="<?= $cl->getId() ?>">SUPPRIMER</button></td>
    </tr>
      <?php }
    ?>
...
<div class="modal fade" id="basicExampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    ...
    <form method="POST" action="/mesprojets/BDP-ORM/Compte/newCompteNC">
